...
//                Log.e("Ficheros", "Error al leer fichero desde tarjeta SD");
     ...
     * @param apuesta La apuesta a la jugada (Fijo, Corrido, Parlet, Camdado,
     * Centena)
    ...
    *
    ...
    public void generarReporteHtml(String html) {
        ...
        try {
            ...
            System.out.println("Ficheros " + "Error al escribir fichero a tarjeta SD");
        }

    }
    
    /**
     * Metodo para escribir el reporte.html 
     * @param html Contenido html que va a ser escrito en el fichero
    *
     */
    public void generarResumenHtml(String html) {

        try {
            File f = new File(dir.get().getPath() + "/ResumenCompleto/", "index.html");
     ...
     *
     * @param filasTablaLista Contenido html que genera las filas de la tabla de
     * las Listas
     * @param totalFilaTablaLista Contenido html que genera los totales de la
     * tabla Listas
     * @param filasTablaBote Contenido html que genera las filas de la tabla del
     * Bote
     * @param totalFilaTablaBote Contenido html que genera os totales de la
     * tabla Bote
     *
     *
     */
...
"<strong>Nota:</strong> A continuación se muestra el resumen semanal generado automaticamente para la aplicación Lotto-Desktop 1.3.0 Beta.</div>\n" +
"<div id = contenedor>\n" +
"    <input id = tab-1 type  =radio name  = radio-set class=tab-selector-1 checked=checked/>\n" +
"    <label for=tab-1 class=tab-label-1\\>Resumen Semanal</label>    \n" +
"    <div class=content>\n" +
"        <div class=content-1>\n" +
"           <table id =content-1 class=content>\n" +
"				<tr>\n" +
"					<th scope = col  style = \"padding-right : 30px\">DIA_SEMANA</th>\n" +
"					<th scope = col  style = \"padding-right : 30px\">LISTA</th>\n" +
"					<th scope = col  style = \"padding-right : 30px\">LIMPIO</th>\n" +
"					<th scope = col  style = \"padding-right : 30px\">GANA</th>\n" +
"					<th scope = col  style = \"padding-right : 30px\">PIERDE</th>\n" +
"					<th scope = col  style = \"padding-right : 30px\">FONDO</th>\n" +
"					<th scope = col  style = \"padding-right : 30px\">#_DEL_TIRO</th>\n" +
"				</tr> \n" 
                                        + "<tr>" + filasTabla + "<tr>" + totalFilaTabla + 
